...
function App() {
  ...
  const infoProject = [
    ...
    {
        id : 1,
        name : toggleButtonLanguage ? "Cabinet d'architecture" : 'Architect WebSite',
        description : toggleButtonLanguage 
  ...
  return (
    <>
      <Routes>
        <Route path="/" element={<Home  toggleButtonLanguage={toggleButtonLanguage} handleToggleButtonLanguage={handleToggleButtonLanguage} infoProject={infoProject} />} />
        <Route path="/project/:id" element={<ProjectPage infoProject={infoProject} toggleButtonLanguage={toggleButtonLanguage}  handleToggleButtonLanguage={handleToggleButtonLanguage}/>} />
      </Routes>
    </>
  )
}
