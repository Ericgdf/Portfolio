...
const LandingPage = ({ toggleButtonLanguage }) => {
  ...
  useEffect(() => {
    ...
    zoomTl
      .to(introText.current, { display: "none", opacity: 0 })
      .fromTo(
      ...
      .fromTo(
        presentationBackground.current,
  ...
  return (
    ...
    >
      ...
      <div className="text-landing-page" ref={introText}>
        <p className="text-landing-page">
          {toggleButtonLanguage ? "Bonjour, je suis Eric" : "Hello, I'm Eric"}
        </p>
        <h1 className="title-landing-page">
          {toggleButtonLanguage ? "Developpeur Web" : "Web Developer"}
        </h1>
        <p className="text-landing-page">
          {toggleButtonLanguage
