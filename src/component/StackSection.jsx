...
const StackSection = ({toggleButtonLanguage}) => {
    ...
    <div className='stack-background' ref={stackBackground}>
        ...
        <div className='travel-section'>
            <div className="design-section" ref={designSection}>
                <p className="explanation">{toggleButtonLanguage ? "D'abord penser le design" : "First came the idea"}</p>
        ...
        <div className='travel-section'>
            ...
            <div className="design-section right" ref={frontSection}>
                <p className="explanation">{toggleButtonLanguage ? "Fabrication du front" : "Then time to design front-end"}</p>
                <div className="icon-container">
                    <div className="element-icon">
        ...
        <div className='travel-section'>
            ...
            <div className="design-section" ref={backSection}>
                <p className="explanation">{toggleButtonLanguage ? "Pour le back" : "Back-end side"}</p>
                <div className="icon-container">
                    <div className="element-icon">
